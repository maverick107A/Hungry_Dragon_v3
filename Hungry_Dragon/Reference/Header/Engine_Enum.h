...
namespace Engine
{
	...
	enum BUFFERID{ BUFFER_RCCOL, BUFFER_TERRAIN, BUFFER_FACE, BUFFER_TWINFACE, BUFFER_JAW, BUFFER_BODY, BUFFER_WING, BUFFER_LWING, BUFFER_TEXCUBE,BUFFER_TEXSQUARE,
		...
		BUFFER_RIGHTHAND , BUFFER_LEFTHAND, BUFFER_GOLEMBODY , FLYMOB_BODY, FLYMOB_WL, FLYMOB_WR, BUFFER_RABBIT, BUFFER_PIG , BUFFER_BOMB, BUFFER_CIRCLE ,BUFFER_TORUS, BUFFER_END
	};
