...
namespace Engine
{
	...
	enum BUFFERID{ BUFFER_RCCOL, BUFFER_TERRAIN, BUFFER_FACE, BUFFER_JAW, BUFFER_TEXCUBE,BUFFER_TEXSQUARE,
		...
		BUFFER_ROCKMESH, BUFFER_DIAMESH, BUFFER_TREEMESH, BUFFER_CHRYSTAL, BUFFER_DIAMOB_UPPER,BUFFER_DIAMOB_UNDER,BUFFER_END
	};
