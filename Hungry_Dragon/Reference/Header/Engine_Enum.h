...
namespace Engine
{
	...
	enum BUFFERID{ BUFFER_RCCOL, BUFFER_TERRAIN, BUFFER_FACE, BUFFER_TWINFACE, BUFFER_JAW, BUFFER_BODY, BUFFER_WING, BUFFER_TEXCUBE,BUFFER_TEXSQUARE,
		...
		BUFFER_ROCKMESH, BUFFER_DIAMESH, BUFFER_TREEMESH, BUFFER_CHRYSTAL, BUFFER_DIAMOB_UPPER,BUFFER_DIAMOB_UNDER,
		BUFFER_RIGHTHAND , BUFFER_LEFTHAND, BUFFER_GOLEMBODY ,  BUFFER_END
	};

	enum PARTICLEID { PART_ATK, PART_WIND,PART_FRAGILE, PART_END };	//파티클 클래스별 enum
