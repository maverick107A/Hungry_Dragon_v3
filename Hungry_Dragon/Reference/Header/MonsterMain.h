...
public:
	...
	enum MONSTERVARIATION { MONSTER_JUMP, MONSTER_CHASE, MONSTER_FLY, MONSTER_RUN, MONSTER_RANDGOLEM, MONSTER_BAT, MONSTER_FLYGOLEM, MONSTER_FLYCHASEGOLEM, MONSTER_FLYRUNGOLEM, MONSTER_BOSSGOLEM, MONSTER_HORIZONBAT, MONSTER_VARIEND };
