...
namespace Engine
{
	...
	enum BUFFERID{ BUFFER_TRICOL, BUFFER_RCCOL, BUFFER_RCTEX, BUFFER_TERRINTEX, BUFFER_TERRAIN, BUFFER_CUBEDRA, BUFFER_CUBETEX, BUFFER_TERRAINTEX, BUFFER_FOREST, BUFFER_RIFT, BUFFER_VOLCANO, BUFFER_ICEAGE, BUFFER_END	};
