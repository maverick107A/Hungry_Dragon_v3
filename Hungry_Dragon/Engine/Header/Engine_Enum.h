...
namespace Engine
{
	...
	enum BUFFERID{ BUFFER_RCCOL, BUFFER_TERRAIN, BUFFER_FACE, BUFFER_TWINFACE, BUFFER_JAW, BUFFER_BODY, BUFFER_WING, BUFFER_LWING, BUFFER_TEXCUBE,BUFFER_TEXSQUARE,
		...
		BUFFER_RIGHTHAND , BUFFER_LEFTHAND, BUFFER_GOLEMBODY , FLYMOB_BODY, FLYMOB_WL, FLYMOB_WR, BUFFER_RABBIT, BUFFER_PIG , BUFFER_END
	};

	enum ANIMATION { ANI_IDLE, ANI_EAT, ANI_FLY, ANI_BREATHIDLE, ANI_BREATHFLY, ANI_FASTFLY, ANI_FASTBREATH, ANI_END };

	enum PARTICLEID { PART_ATK, PART_WIND, PART_FRAGILE, PART_LEAF, PART_BEAM,PART_END };	//파티클 클래스별 enum
