#include "VolcanoLand.h"
#include "ResourcesMgr.h"

USING(Engine)

Engine::CVolcanoLand::CVolcanoLand(LPDIRECT3DDEVICE9 pGraphicDev)
	: CBaseLand(pGraphicDev)
{

}

Engine::CVolcanoLand::CVolcanoLand(const CVolcanoLand& rhs)
	: CBaseLand(rhs)
{

}

Engine::CVolcanoLand::~CVolcanoLand(void)
{

}

HRESULT Engine::CVolcanoLand::Ready_Buffer(void)
{
	_ulong dwCntX = 129;
	_ulong dwCntZ = 129;
	_ulong dwVtxItv = 200;
...
void Engine::CVolcanoLand::Render_Buffer(void)
{
...
void Engine::CVolcanoLand::Free(void)
{
	Safe_Release(m_pTerrainTex);
	CResources::Free();
}

CVolcanoLand* Engine::CVolcanoLand::Create(LPDIRECT3DDEVICE9 pGraphicDev)
{
	CVolcanoLand*	pInstance = new CVolcanoLand(pGraphicDev);
...
CComponent* Engine::CVolcanoLand::Clone(void)
{
	return new CVolcanoLand(*this);
}
