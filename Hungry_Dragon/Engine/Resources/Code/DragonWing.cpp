...
Engine::CDragonWing::CDragonWing(LPDIRECT3DDEVICE9 pGraphicDev)
	: CVIBuffer(pGraphicDev)
{

}

Engine::CDragonWing::CDragonWing(const CDragonWing& rhs)
	: CVIBuffer(rhs)
{

}

Engine::CDragonWing::~CDragonWing(void)
{

}

HRESULT Engine::CDragonWing::Ready_Buffer(void)
{
	m_dwVtxCnt = 76;
	m_dwTriCnt = 40;
...
void Engine::CDragonWing::Render_Buffer(void)
{
	m_pVB->Unlock();
...
void Engine::CDragonWing::Free(void)
{
	CVIBuffer::Free();
}

CDragonWing* Engine::CDragonWing::Create(LPDIRECT3DDEVICE9 pGraphicDev)
{
	CDragonWing*	pInstance = new CDragonWing(pGraphicDev);
...
CComponent* Engine::CDragonWing::Clone(void)
{
	return new CDragonWing(*this);
}
