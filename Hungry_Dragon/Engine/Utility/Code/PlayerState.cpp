...
bool CPlayerState::Land_Check(float* _fHeight, _vec3* _vNorm)
{
	...
	{
		Vertex1.y = (float)pTerrain->Get_AdvanceHeight()[Vernum] +20.f;
		Vertex2.y = (float)pTerrain->Get_AdvanceHeight()[Vernum + 1] + 20.f;
		Vertex3.y = (float)pTerrain->Get_AdvanceHeight()[Vernum + VERTEXSIZE]  + 20.f;
	...
	else
	{
		Vertex2.y = (float)pTerrain->Get_AdvanceHeight()[Vernum + 1] + 20.f;
		Vertex3.y = (float)pTerrain->Get_AdvanceHeight()[Vernum + VERTEXSIZE] + 20.f;
		Vertex4.y = (float)pTerrain->Get_AdvanceHeight()[Vernum + VERTEXSIZE + 1]  + 20.f;
