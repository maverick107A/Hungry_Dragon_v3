...
void CIngame_Info::Render_UI()
{
	...
	{
		Draw_Tex(m_pPolygon, 128, 128, tPack.vScale.x, tPack.vScale.y, 0.f, 0.f, tPack.vRot.z, tPack.vPos.x, tPack.vPos.y, tPack.dwColor + 0xab000000);
		//CLine_Renderer::GetInstance()->Draw_DotSprite(m_pSprite, tPack.vPos.x, tPack.vPos.y, 2.f, 2.f, tPack.dwColor); // 뭔가 터짐
	...
	//wsprintf(str, L"라인렌더 수 : %d", CLine_Renderer::GetInstance()->Get_Size());
