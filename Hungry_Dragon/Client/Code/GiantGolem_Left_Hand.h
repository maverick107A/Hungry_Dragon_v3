#ifndef GiantGolem_Left_Hand_h__
#define GiantGolem_Left_Hand_h__
...
class  CGiantGolem_Left_Hand : public Engine::CMonsterMain
{
private:
	explicit CGiantGolem_Left_Hand(LPDIRECT3DDEVICE9 pGraphicDev);
	virtual ~CGiantGolem_Left_Hand(void);
public:
...
public:
	static CGiantGolem_Left_Hand*	Create(LPDIRECT3DDEVICE9 pGraphicDev, Engine::CMonsterMain* pObject);
