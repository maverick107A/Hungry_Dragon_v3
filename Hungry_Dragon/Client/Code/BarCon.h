...
class CBarCon : public Engine::CGameObject
{
private:
	explicit CBarCon(LPDIRECT3DDEVICE9 pGraphicDev);
	virtual ~CBarCon(void);
...
public:
	static CBarCon*	Create(LPDIRECT3DDEVICE9 pGraphicDev);
private:
