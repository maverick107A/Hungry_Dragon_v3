...
CGiantGolem_Left_Arm::CGiantGolem_Left_Arm(LPDIRECT3DDEVICE9 pGraphicDev)
	:Engine::CMonsterMain(pGraphicDev)
{
}

CGiantGolem_Left_Arm::~CGiantGolem_Left_Arm(void)
{
}

HRESULT CGiantGolem_Left_Arm::Ready_Object(void)
{
...
int CGiantGolem_Left_Arm::Update_Object(const float & fTimeDelta)
{
...
void CGiantGolem_Left_Arm::Render_Object(void)
{
...
HRESULT CGiantGolem_Left_Arm::Add_Component(void)
{
...
void CGiantGolem_Left_Arm::LateUpdate_Object(const float & fTimeDelta)
{
	Engine::CMonsterMain::LateUpdate_Object(fTimeDelta);
}

CGiantGolem_Left_Arm * CGiantGolem_Left_Arm::Create(LPDIRECT3DDEVICE9 pGraphicDev, Engine::CMonsterMain* pObject)
{
	CGiantGolem_Left_Arm*		pInstance = new CGiantGolem_Left_Arm(pGraphicDev);
...
void CGiantGolem_Left_Arm::Free(void)
{
