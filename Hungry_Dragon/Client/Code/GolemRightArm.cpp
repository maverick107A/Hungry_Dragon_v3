...
CGolemRightArm::CGolemRightArm(LPDIRECT3DDEVICE9 pGraphicDev)
	:Engine::CMonsterMain(pGraphicDev)
{
}

CGolemRightArm::~CGolemRightArm(void)
{
}
...
int CGolemRightArm::Update_Object(const float & fTimeDelta)
{
...
void CGolemRightArm::LateUpdate_Object(const float & fTimeDelta)
{
