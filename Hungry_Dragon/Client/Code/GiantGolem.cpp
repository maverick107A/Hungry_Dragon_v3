...
void CGiantGolem::Preset_Animation()
{
	...
	m_pAnimationController->Insert_Trans(PAT_IDLE, PART_BODY, 0, _vec3(0.f, 0.f, 0.f));
	// Head
	...
	// 바디 원래위치로!
	m_pAnimationController->Insert_Scale(PAT_PUNCH, PART_BODY, 40, _vec3(1000.f, 1300.f, 1000.f));
	m_pAnimationController->Insert_Trans(PAT_PUNCH, PART_BODY, 40, _vec3(0.f, 0.f, 0.f));
	m_pAnimationController->Insert_Scale(PAT_PUNCH, PART_HEAD, 40, _vec3(200.f, 200.f, 200.f));
	m_pAnimationController->Insert_Trans(PAT_PUNCH, PART_HEAD, 40, _vec3(100.f, 700.f, 100.f));

	m_pAnimationController->Insert_Scale(PAT_PUNCH, PART_RIGHTARM,  40, _vec3(500.f, 500.f, 500.f));
	m_pAnimationController->Insert_Rotate(PAT_PUNCH, PART_RIGHTARM, 40, _vec3(-fQater, 0.f, 0.f));
	m_pAnimationController->Insert_Trans(PAT_PUNCH, PART_RIGHTARM,  40, _vec3(1700, 800.f, 0.f));

	m_pAnimationController->Insert_Scale(PAT_PUNCH, PART_RIGHTHAND,  40, _vec3(500.f, 500.f, 500.f));
	m_pAnimationController->Insert_Rotate(PAT_PUNCH, PART_RIGHTHAND, 40, _vec3(0.f, 2.8f, 0.f));
	m_pAnimationController->Insert_Trans(PAT_PUNCH, PART_RIGHTHAND,  40, _vec3(0.f, -1200.f, 0.f));
	...
	//
	//// 양팔 수직 상승
	//m_pAnimationController->Insert_Scale(PAT_SOLARBEAM, PART_RIGHTARM, 10, _vec3(500.f, 500.f, 500.f));
	//m_pAnimationController->Insert_Rotate(PAT_SOLARBEAM, PART_RIGHTARM, 10, _vec3(-D3DX_PI, 0.f, 1.f));
	//m_pAnimationController->Insert_Trans(PAT_SOLARBEAM, PART_RIGHTARM, 10, _vec3(1700, 800.f, 0.f));

	//m_pAnimationController->Insert_Scale(PAT_SOLARBEAM,  PART_LEFTARM, 10, _vec3(500.f, 500.f, 500.f));
	//m_pAnimationController->Insert_Rotate(PAT_SOLARBEAM, PART_LEFTARM, 10, _vec3(-D3DX_PI, -D3DX_PI, 1.f));
	//m_pAnimationController->Insert_Trans(PAT_SOLARBEAM,  PART_LEFTARM, 10, _vec3(-1700, 800.f, 0.f));
	//
